...
// إذا كان هناك رسالة نجاح (مثل بعد تسجيل حساب جديد)
            ...
            <div class="login-content">
                ...
                <ul class="features-list">
                    ...
                    <li>
                        ...
                        <span>إدارة متكاملة للعمال والرواتب</span>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <span>واجهة متجاوبة مع جميع الأجهزة</span>
                    </li>
                    <li>
            ...
            <div class="login-card">
                ...
                <div style="text-align: center; margin-top: 30px; padding-top: 20px; border-top: 1px solid #e9ecef;">
                    <p style="color: #6c757d; font-size: 0.9rem;">
                        ...
                        للدعم الفني: <a href="tel:+966500000000" style="color: var(--secondary);">+966 50 000 0000</a>
                    </p>
                </div>
            </div>
        </div>
